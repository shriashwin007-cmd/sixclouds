...
export default function ScrollVideoIntro() {
  ...
  useEffect(() => {
    ...
    const show = (idx: number) => {
      if (idx === shownFrame.current || !ready.current[idx]) return;
  ...
  return (
    <div ref={containerRef} style={{ height: "300vh", position: "relative" }}>
      <div style={{ position: "sticky", top: 0, height: "100svh", overflow: "hidden", background: "#000" }}>
        ...
        {progress < 1 && (
          <div style={{
            ...
            <span className="mono" style={{ fontSize: "0.62rem", letterSpacing: "0.22em", textTransform: "uppercase", color: "rgba(255,215,0,0.5)" }}>
              Loading {Math.round(progress * 100)}%
            </span>
          </div>
        )}

        {/* Scroll hint — gold style */}
        <div ref={hintRef} style={{
          ...
          <span className="mono" style={{ fontSize: "0.62rem", letterSpacing: "0.24em", textTransform: "uppercase", color: "rgba(255,215,0,0.6)" }}>
            Scroll to enter
          </span>
          <svg width="20" height="32" viewBox="0 0 20 32" fill="none">
            <rect x="1" y="1" width="18" height="26" rx="9" stroke="rgba(255,215,0,0.4)" strokeWidth="1.5"/>
            <circle cx="10" cy="9" r="2.5" fill="rgba(255,215,0,0.8)">
            ...
            <polyline points="7,29 10,32 13,29" fill="none" stroke="rgba(255,215,0,0.4)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
          </svg>
        </div>
        ...
        <div ref={overlayRef} style={{
          ...
          background: "linear-gradient(to bottom, rgba(5,5,5,0) 0%, #050505 70%)",
